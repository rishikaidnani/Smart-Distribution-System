...
public class ManageEnterpriseAdminJPanel extends javax.swing.JPanel {
        ...
        for (Network network : system.getNetworkDirectory().getNetworkList()) {
            for (Enterprise enterprise : network.getEnterpriseDirectory().getEnterpriseList()) {
                if (enterprise instanceof CDCEnterprise
                        || enterprise instanceof NationalDistributorEnterprise) {
    ...
    public void reset() {
        enterprisePersonNameJTextField.setText("");
    ...
    private void initComponents() {
        ...
        enterprisePersonNameJTextField = new javax.swing.JTextField();
        ...
        enterpriseNameJLabel.setText("Enterprise Person Name");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(enterprisePersonNameJTextField)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(enterpriseNameJLabel)
                            .addComponent(enterprisePersonNameJTextField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(userNameJLabel)
    ...
    private void submitJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitJButtonActionPerformed
        // TODO add your handling code here:
        String enterprisePersonName = enterprisePersonNameJTextField.getText();
        String userName = userNameJTextField.getText();
        String password = String.valueOf(passwordJPasswordField.getPassword());
        String confirmPassword = String.valueOf(confirmPasswordJPasswordField.getPassword());

        if (enterprisePersonName.trim().equals("")
        ...
        if (enterprise != null) {
            Person person = enterprise.getPersonDirectory().addAndCreatePerson(enterprisePersonName);
    ...
    private javax.swing.JTextField enterprisePersonNameJTextField;
